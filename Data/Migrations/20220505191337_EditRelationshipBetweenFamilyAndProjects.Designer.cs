...
namespace Etaa.Data.Migrations
{
    ...
    [Migration("20220505191337_EditRelationshipBetweenFamilyAndProjects")]
    partial class EditRelationshipBetweenFamilyAndProjects
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Etaa.Models.Projects", b =>
                {
                    ...
                    b.HasOne("Etaa.Models.NumberOfFunds", "NumberOfFunds")
                        .WithMany("Projects")
                        .HasForeignKey("NumberOfFundsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Etaa.Models.ProjectTypes", "ProjectTypes")
                        .WithMany()
            ...
            modelBuilder.Entity("Etaa.Models.ProjectsSelectionReasons", b =>
                {
                    b.HasOne("Etaa.Models.Projects", "Projects")
                        .WithMany("ProjectsSelectionReasons")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Etaa.Models.ProjectsSocialBenefits", b =>
                {
                    b.HasOne("Etaa.Models.Projects", "Projects")
                        .WithMany("ProjectsSocialBenefits")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Etaa.Models.Projects", b =>
                {
                    b.Navigation("ProjectsAssets");

                    b.Navigation("ProjectsSelectionReasons");

                    b.Navigation("ProjectsSocialBenefits");
                });
